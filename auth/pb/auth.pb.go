...
var file_auth_pb_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_auth_pb_auth_proto_depIdxs = []int32{
	0, // 0: AuthService.GetToken:input_type -> Credentials
	1, // 1: AuthService.ValidateToken:input_type -> Token
	1, // 2: AuthService.GetToken:output_type -> Token
